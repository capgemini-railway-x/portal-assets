...
OSPs, short for Onboarding Service Provider, are participants of the Railway-X dataspace, that enable and offer an alternative (to the usual registration process) way of getting access to the dataspace. OSPs integrate features for registration to Railway-X into their own information systems (eg. into their own portals or applications) and provide you with the option to register using their services and your already existing credentials for the OSPs systems.
...
The first step is to find an OSP. You're existing partners, that happen to be OSPs for Railway-X might inform you about their status as OSPs and offer you the opportunity to become a participant in the Railway-X network. Alternatively you can find the list provided by the association, that lists all available OSPs. The individual onboarding process depends on the OSPs individual implementation. That might ie. be a registration form or a semi automatic process handled by your OSP. Ideally you get in contact with them and discuss the available options in order to figure out the available/best ways to proceed.
