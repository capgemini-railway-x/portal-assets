...
Administration users can change company users assigned portal roles by using the "User Management" -> "Identity Management" -> Edit User Account by clicking on "Details" -> scroll down to section "Assigned Railway-X Portal Roles"
<br>
