...
In the scenario of federated company IdP user accounts, the user deletion will only be effective inside the Railway-X idp. The company IdP wont be effective on the company IdP; only the shadow user with the assigned roles inside Railway-X will get deleted.
