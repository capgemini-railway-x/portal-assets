...
Inside the Railway-X world, managing your identity and data securely and efficiently is one of the key targets.
In the context of identity, Railway-X dataspace manages the following identity types:
