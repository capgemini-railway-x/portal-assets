...
## How can I invite a potential new Railway-X member?

In the first implementation level, Railway-X members can get invited by the operator only.
...
If you go to the partner network and search for a company, check out the membership icon. If the CX icon is displayed (example see screenshot below) the company is a member of Railway-X.
<br>
<br>
