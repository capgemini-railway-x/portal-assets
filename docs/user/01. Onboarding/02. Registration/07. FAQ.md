...
As soon as the company registration is submitted, the Railway-X operator will validate the data for correctness and initiate the automatic registration process. This includes the legal validation, the Gaia-X compliance check as well as the creation of the company account.
