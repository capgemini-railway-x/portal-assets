...
The registration process includes the onboarding of an organization. A natural person does not need an onboarding in Railway-X.
<br>
<br>
...
Pre-condition: The authorized organization onboarding party must have received a Railway-X invite and needs to have valid documents of the organization (e.g. commercial register excerpt, certifications).
<br>
<br>
